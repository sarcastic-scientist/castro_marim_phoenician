...
\begin{frontmatter}
  ...
  \title{Insights into agricultural practices at the Phoenician site of Castro Marim between 7\textsuperscript{th} -- 5\textsuperscript{th} century BCE}
    \author[Universidade de \unexpanded{É}vora,Laborat\unexpanded{ó}rio HERCULES,Sapienza Universit\unexpanded{à} di Roma]{Roshan Paladugu%
  %
  \fnref{1}}
   \ead{rpaladugu@uevora.pt} 
    \author[Sapienza Universit\unexpanded{à} di Roma]{Alessandra Celant%
  %
  \fnref{2}}
   \ead{alessandra.celant@uniroma1.it} 
    \author[Sapienza Universit\unexpanded{à} di Roma]{Federico Di Rita%
  %
  \fnref{2}}
  ...
  \fnref{2}}
   \ead{e.sousa@campus.ul.pt} 
    \author[Universidade de \unexpanded{É}vora,Laborat\unexpanded{ó}rio HERCULES]{Anne-France Maurer%
  %
  \fnref{2}}
   \ead{annefrance.maurer@gmail.com} 
    \author[Sapienza Universit\unexpanded{à} di Roma]{Donatella Magri%
  %
  \fnref{2}}
   \ead{donatella.magri@uniroma1.it} 
    \author[Universidade de \unexpanded{É}vora,Laborat\unexpanded{ó}rio HERCULES]{Cristina Barrocas Dias%
  %
  \fnref{1}}
   \ead{cmbd@uevora.pt} 
      \affiliation{organization={Universidade de \unexpanded{É}vora},
            addressline={Departamento de Qu\unexpanded{í}mica,
                Escola de Ci\unexpanded{ê}ncias e Tecnologia,
                Col\unexpanded{é}gio Lu\unexpanded{í}s Verney,
                Rua Rom\unexpanded{ã}o Ramalho 59},
            postcode={7000-671},
            city={\unexpanded{É}vora},
            country={Portugal}}
      \affiliation{organization={Laborat\unexpanded{ó}rio HERCULES},
            addressline={Universidade de \unexpanded{É}vora,
                Pal\unexpanded{á}cio do Vimioso,
                Largo Marqu\unexpanded{ê}s de Marialva 8},
            postcode={7000-554},
            city={\unexpanded{É}vora},
            country={Portugal}}
      \affiliation{organization={Sapienza Universit\unexpanded{à} di Roma},
            addressline={Dipartimento di Biologia Ambientale,
                Sapienza Universit\unexpanded{à} di Roma,
                Piazzale A. Moro 5},
            postcode={00185},
            city={Italy},
            country={Portugal}}
...
\leavevmode\vadjust pre{\hypertarget{ref-guiry_etal21a}{}}%
